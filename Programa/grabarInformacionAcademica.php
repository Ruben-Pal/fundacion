...
$query = "INSERT INTO informacion_academica (Id_InformacionAcademica  , Inf_informeacademico , Inf_grado,  Inf_colegio ,Inf_sede ,Inf_nombresede,Id_taller)
VALUES ($codigo,'$Inf_informeacademico', '$Inf_grado' , '$Inf_colegio', '$inf_sede' , '$Inf_nombresede',$taller)";
