...
<table width="900" border="1">
	...
	<?php
		...
		$query="SELECT 
			    ...
			    FROM refuerzodescripcion_taller
			    INNER JOIN tutor ON tutor.Id_Refuerzo=refuerzo.Id_Refuerzo
			    order by 1";
			
		
			
$result=mysqli_query($link,"select * from tutor")  or die("error en la consulta");			
