...
$query = "INSERT INTO acudiente(Id_Acudiente,Acu_nombreacudiente,Acu_apellidoacudiente,Acu_tipodocumento,Acu_edad,Acu_telefono,Acu_direccion, Acu_barrio,Id_Socioeconomico) 
VALUES ('$codigo','$Acu_nombreacudiente','$Acu_apellidoacudiente','$Acu_tipodocumento','$Acu_edad','$Acu_telefono','$Acu_direccion','$Acu_barrio','$EstadoSocioeconomico')";
