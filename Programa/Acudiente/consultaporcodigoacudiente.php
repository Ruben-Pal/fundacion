...
function validar(formulario)
{
	...
	{
		alert('Sr Usuario debe ingresar el codigo del Acudiente a consultar');
...
<center>
<form id="form1" name="form1" method=post onsubmit="return validar(this)" action="consultarporacudiente.php">
